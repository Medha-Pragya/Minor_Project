...
//game.distanceForLevelUpdate
        if (Math.floor(game.distance) %  game.distanceForLevelUpdate == 0 && Math.floor(game.distance) > game.levelLastUpdate) {
            ...
            game.level++;
            const color1 = ['','','#f7f413','#e413b9','#6e19d5','#578d03'] 
            const color2 = ['','','#f1f0bc','#e9b6de','#cab7e1','#c9e9bd'] 
            /*let r1 = game.level*32, g1=255, b1=255,
            r2 = game.level*16, g2=255, b2 = 255;
            ...
            if(g2>255) g2 = 255;
            if(b2>255) b2 = 255;
            document.getElementById('gameHolder').style.background = 'linear-gradient( rgba(' +
               r1+','+g1+','+b1 +', 1), rgba(' + 
               r2+','+g2+','+b2 +', 1) )' *///color1[game.level] 
            document.getElementById('gameHolder').style.background = 'linear-gradient('+color1[game.level]+','+color2[game.level]+')'
            fieldLevel.innerHTML = Math.floor(game.level);
